...
import 'adm_panel_model.dart';
export 'adm_panel_model.dart';

class AdmPanelWidget extends StatefulWidget {
  const AdmPanelWidget({super.key});

  static String routeName = 'admPanel';
  static String routePath = '/admPanel';

  @override
  State<AdmPanelWidget> createState() => _AdmPanelWidgetState();
}

class _AdmPanelWidgetState extends State<AdmPanelWidget> {
  late AdmPanelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdmPanelModel());
  }
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      listViewCitasRecord.tipoVehiculo,
                                      style: FlutterFlowTheme.of(context)
                                          .titleMedium
                                          .override(
                                            font: GoogleFonts.interTight(
