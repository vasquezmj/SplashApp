      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => ReservarCitaWidget(
            nombreServicio: params.getParam(
              'nombreServicio',
              ParamType.String,
            ),
            precioBase: params.getParam(
              'precioBase',
              ParamType.double,
            ),
            imagenServicio: params.getParam(
              'imagenServicio',
              ParamType.String,
            ),
        ...
        FFRoute(
          ...
          builder: (context, params) =>
              params.isEmpty ? NavBarPage(initialPage: 'flota') : FlotaWidget(),
        ),
        FFRoute(
          name: PersonalWidget.routeName,
          path: PersonalWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'personal')
              : PersonalWidget(),
        ),
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'citasAdm')
              : CitasAdmWidget(),
        ),
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'admPanel')
              : AdmPanelWidget(),
        ),
        FFRoute(
